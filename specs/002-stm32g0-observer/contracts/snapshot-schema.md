# Contract: STM32G0 Demonstration Snapshot Envelope

Each snapshot is a little-endian, bounded envelope owned by the running demonstration firmware.

| Field | Required validation |
|---|---|
| Magic | Exact versioned demonstration snapshot identifier |
