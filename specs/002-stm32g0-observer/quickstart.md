# Quickstart: Validate STM32G0 Demonstration Observation

## Prerequisites

- Android API 23+ device with USB OTG
- STLINK-V3 in a supported debug mode
- Powered STM32G0B0RET6 demonstration board
...
3. Confirm programmer firmware, target voltage, chip ID `0x467`, and demonstration firmware identity.
