# Research: STM32G0 Realtime Viewer Transport

## Decision 1: Snapshot-first observation

**Decision**: Read coherent, versioned demonstration-board snapshots as the primary data source.
Permit direct register reads only from an explicit safe-read catalog.
